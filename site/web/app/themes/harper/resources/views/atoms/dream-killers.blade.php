<div class="bordered">
  <section id="section-dream-killers" class="section dream-killers">
    <div class="container">
      <div class="columns">
        <div class="column">
          <h1 class="display is-1 is-uppercase black">&ldquo;Dream Killers&rdquo;</h1>
          <h2 class="subtitle bg-black is-2 is-uppercase">These Democrats don't share our values. They chose money, corporations and politics over people. If they don't get it together, we're coming for their seats in 2020.</h2>
        </div>
      </div>
     ...
     <div class="columns is-8">
       ...
       <div class="column push-">
         ...
         <h2 class="is-4 title">U.S. House of Representatives, District 7</h2>
         <p class="lh-copy">
